...
class Npc(Entity):
    def __init__(self, npc_name, pos, groups, obstacle_sprites, dialog):
        ...
        self.or_image = pygame.transform.scale(pygame.image.load(resource_path('assets/graphics/npcs/npc_1.png')), (TILESIZE, TILESIZE))
        ...
        # self.lines_en = ['Just give up.', 'You can\'t go out there.', 'No chance.', 'We just stuck in here.']
        # self.lines_tch = ['放棄吧。', '你不可能出去的。', '沒有任何可能性。', '我們被困在這了。']
        # self.lines_sch = ['放弃吧。', '你不可能出去的。', '没有任何可能性。', '我们被困在这了。']
